  ...
  return (
    <>
      ...
      >
        ...
        <CModalBody>
          Are you sure you want to {props.status == 1 ? "block" : "unblock"}{" "}
          this {props.info}?
          {props.message ? (
            <div style={{ marginTop: "1rem" }}>{props.message}</div>
          ) : null}
        </CModalBody>
        <CModalFooter>
          <CButton
          ...
          <CButton color="danger" onClick={props.toggleModal}>
            Cancel
          </CButton>
        </CModalFooter>
      </CModal>
    ...
    <>
      ...
      >
        <CModalHeader
          ...
          closeButton
        >
          <CModalTitle>{`Delete ${props.info}`}?</CModalTitle>
        </CModalHeader>
        <CModalBody>
    ...
    <>
      ...
      >
        <CModalHeader
          ...
          closeButton
        >
          <CModalTitle>{`Confirm ${props.info}`}?</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <div>
          ...
          <div style={{ marginTop: "1rem" }}>
            <strong style={{ marginBottom: "1rem" }}>Description: </strong>{" "}
            <CustomEditorViewer
  ...
  return (
    <>
      ...
      >
        ...
        <CModalBody>{props.toggleData?.message}</CModalBody>
        <CModalFooter>
          <CButton
            //color="success"
            style={{ backgroundColor: "#008080", color: "#fff" }}
