...
import { verifyOTP, UpdateEmailOrPhone } from '../../api';
...
export default function OtpVerify() {
        ...
        try {
            ...
            if (result) {
                history.push({
                    ...
                    state: { data: location.state.type === "email" ? 'Email Updated Successfully' : 'Phone Number Updated Successfully', type: 'edit' }
                });
            }
    ...
    const handleResendOtp = async () => {
        try {
            await UpdateEmailOrPhone(userId, location.state.email);
            setModal(!modal);
        } catch (error) {
