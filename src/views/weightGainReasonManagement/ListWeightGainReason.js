...
function ListWeightGainReason() {
    ...
    let deleteQuestion =(item) => {
        ...
        deleteReason(req).then((response) => {
                setStatus(!status)
                    ...
                    <CCard>
                        <CCardHeader>
                            {/* <div style={{display:"flex", justifyContent:"space-between"}}> */}
                                <h2>Weight Gain Reason Management</h2>
                                <CButton
                            ...
                            return (
                                <td>
                                    <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-around" }}>
                                        <CTooltip content={"Edit Weight Gain Reason"} placement={"top-start"}>
                                            <CIcon style={{ color: "black", cursor: "pointer" }}
                                                size="lg"
                                                name={"cilPencil"}
                                                onClick={()=>history.push(`/editWeightGainReason/${item.id}`)}
                                            />
                                        </CTooltip>
                                        ...
                                        <CTooltip content={`Delete Weight Gain Reason`} placement={"top-start"}>
