...
function AddEditWeightGainReason() {
  ...
  let handleAddReasonField = () => {
    ...
    currentReasonInputFields.push({
      reason_no: currentReasonInputFields.length + 1,
      reason_value: "",
      check: false,
    });
    currentReasonInputFields = currentReasonInputFields.map(
      (currentReasonInputField, key) => {
  ...
  let validateField = () => {
    ...
    if (
      ...
      weightFrom &&
      !isNaN(weightFrom) &&
      parseFloat(weightTo) <= parseFloat(weightFrom)
    ) {
    ...
    for (let reasonInputField of currentReasonInputFields) {
      if (
        !reasonInputField.reason_value ||
        reasonInputField.reason_value.trim() == ""
      ) {
  ...
  let handleSubmit = (e) => {
    ...
    let data = {
      ...
      reason: reasonInputFields.map(
        (reasonInputField) => reasonInputField.reason_value
      ),
    };
          ...
          <CCard>
            <CCardHeader>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <h2>
                  {history.location.pathname == "/addWeightGainReason"
                    ? "Add Weight Loss/Gain Reason"
                    : "Edit Weight Loss/Gain Reason"}
                  <CSpinner
                    style={{
                      color: "#008080",
                      marginLeft: "2rem",
            ...
            <CCardBody>
              ...
              >
                <CFormGroup>
                    ...
                    return (
                      <>
                        ...
                        >
                          <CInput
                            onChange={(e) =>
                              handleChangeReasonFieldValue(index, e)
                            }
                          ...
                          <CInputGroupAppend
                            style={{
                              display:
                                reasonInputFields.length > 1 ? "" : "none",
                            }}
                          >
                            <CBadge
                              style={{
                              ...
                              color="danger"
                              onClick={() => handleRemoveReasonField(index)}
                            >
                              <FaMinus />
                            </CBadge>
                          </CInputGroupAppend>
                        ...
                        <div
                          style={{
                            color: "red",
                            marginLeft: "0.1rem",
                            display: reasonInputField.check ? "" : "none",
                          }}
                        >
                          Reason {reasonInputField.reason_no} is required
                        </div>
                      </>
                    );
                  })}
                  <div
                    style={{
                      color: "red",
                      marginLeft: "0.1rem",
                      display: reasonInputFieldsCheck ? "" : "none",
                    }}
                  >
                    Atleast two reason are required
                  </div>
                  <CBadge
                ...
                <CFormGroup>
                  <CLabel
                    style={{ fontWeight: "600", fontSize: "1rem" }}
                    htmlFor="weight_gain_range"
                  >
                    Weight Gain Range:
                  </CLabel>
                  <div
                    style={{ display: "flex", justifyConten: "space-between" }}
                  >
                    <div style={{ width: "45%" }}>
                      <CSelect
                        custom
                      ...
                      <div style={{ width: "45%" }}>
                        ...
                        <div
                          style={{
                            color: "red",
                            marginLeft: "0.1rem",
                            display: weightFromCheck.required ? "" : "none",
                          }}
                        >
                        ...
                        <div
                          style={{
                            color: "red",
                            marginLeft: "0.1rem",
                            display: weightFromCheck.numeric ? "" : "none",
                          }}
                        >
                          Weight from must be numeric
                        </div>
                      </div>
                      <div
                        style={{
                      ...
                      <div style={{ width: "45%" }}>
                        ...
                        <div
                          style={{
                            color: "red",
                            marginLeft: "0.1rem",
                            display: weightToCheck.required ? "" : "none",
                          }}
                        >
                          Weight to name is required
                        </div>
                        <div
                          style={{
                            color: "red",
                            marginLeft: "0.1rem",
                            display: weightToCheck.numeric ? "" : "none",
                          }}
                        >
                          Weight to must be numeric
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    style={{
                      color: "red",
                      marginLeft: "55%",
                      display: weightRangeCheck ? "" : "none",
                    }}
                  >
                    Weight from should be less than weight to
                  </div>
                </CFormGroup>
                    ...
                    >
                      ...
                      {colorCodeList.map((colorCode) => {
                        return (
                          <option
                            style={{
                              backgroundColor: colorCode.name,
                              color: "#fff",
                            }}
                            key={colorCode.id}
                            value={colorCode.id}
